...
valorCompra = float(input('Digite o valor a ser pago: R$ '))
...
if formaPagamento == 1:
    ...
    print('Sua compra de R$ {:.2f} com 10% de desconto, vai custar R$ {:.2f}.'. format(valorCompra, (valorCompra  * 0.9)))
elif formaPagamento == 2:
    print('-------------------------------------------------------------------')
    print('Forma de pagamento escolhida: à vista no cartão com 5% de desconto. ')
    print('Sua compra de R$ {:.2f} com 5% de desconto, vai custar R$ {:.2f}.'.format(valorCompra, (valorCompra * 0.95)))
